...
public class Sala extends javax.swing.JFrame implements IMarcador, ITurnos{
    ...
    public void crearTablero (){
        if (tamanio == 2) {
            matriz=new Linea[19][19];
        } else if (tamanio == 3){
            matriz=new Linea[39][39];
        } else {
            matriz=new Linea[79][79];
        }
    ...
    public void crearPanel (){
        ...
        for (Linea[] linea : tablero.acomodar(true)) {
            for (Linea l : linea) {
                pnlTablero.add(l);
            }
        }
    ...
    public void puntajes() {
        puntajeJ1.setText("Puntaje: " + Integer.toString(marcador.getpJ1()));
        puntajeJ2.setText("Puntaje: " + Integer.toString(marcador.getpJ2()));
        puntajeJ3.setText("Puntaje: " + Integer.toString(marcador.getpJ3()));
        puntajeJ4.setText("Puntaje: " + Integer.toString(marcador.getpJ4()));
    }
